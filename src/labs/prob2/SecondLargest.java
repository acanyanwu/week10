...
public class SecondLSmallest{
	...
	/**
	 * Retrieves the second smallest element using natural order search
	 * @param list
	 * @return
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("second largest integer is: " + getSecondSmallest(intValues).get());
		System.out.println();
        ...
        System.out.println("second largest date is: " + getSecondSmallest(dates).get());
        System.out.println();
